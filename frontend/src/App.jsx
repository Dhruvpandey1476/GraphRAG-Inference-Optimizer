          ...
          <>
            ...
            {results.judge_scores && (
              <div style={{
                ...
                border: `1px solid ${results.judge_scores.winner === "graph_rag" ? "#22c55e44" : "#f9731644"}`,
                borderRadius: 12, padding: "1rem 1.25rem", marginBottom: "1.5rem",
                display: "flex", alignItems: "center", gap: ".75rem",
              }}>
                <CheckCircle size={18} color={results.judge_scores.winner === "graph_rag" ? "#22c55e" : "#f97316"} />
                <div>
                  <strong style={{ color: results.judge_scores.winner === "graph_rag" ? "#22c55e" : "#f97316" }}>
                    {results.judge_scores.winner === "graph_rag" ? "✨ GraphRAG wins" : "Basic RAG wins"} this query
                  </strong>
